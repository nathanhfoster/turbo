...
export const boxShadow: BoxShadowSystem = {
  ...
  "real-play":
    "inset 8px 8px 8px -4px #09090bbf, inset -8px -8px 8px 0px #1a1a1a",
} as const;
...
export const backgroundImage: BackgroundImageSystem = {
  ...
  "noise-right":
    "linear-gradient(269deg,#09090b 0.53%,#0000 98.94%,#0000 98.95%)",
  "gradient-conic":
    "conic-gradient(from 180deg at 50% 50%, var(--tw-gradient-stops))",
  "gradient-live-wins-left":
    "linear-gradient(90deg, #09090B 72.11%, #0000 100%)",
