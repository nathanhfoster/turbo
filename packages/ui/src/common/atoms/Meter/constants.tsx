...
export const DEFAULT_THRESHOLDS: Threshold[] = [
  ...
  { value: 58, color: 'bg-warning/80', label: 'B', labelColor: 'text-warning/80' },
  { value: 64, color: 'bg-warning', label: 'B+', labelColor: 'text-warning' },
  { value: 80, color: 'bg-success/80', label: 'A-', labelColor: 'text-success/80' },
  { value: 90, color: 'bg-success/90', label: 'A', labelColor: 'text-success/90' },
