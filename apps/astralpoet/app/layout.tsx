...
import { EntryContextProvider } from "@/domains/Entry";
import { AstralPoetLayoutContent } from "./components/AstralPoetLayoutContent";
import "./globals.css";

const APP_NAME = "Astral Poet";
const APP_SHORT_NAME = "Astral Poet";
const APP_DESCRIPTION = "A personal diary and journaling app with rich text editing";

export const metadata: Metadata = {
  metadataBase: new URL("https://agentnate.dev/astralpoet"),
  title: {
    default: APP_NAME,
          ...
          <InstallPromptProvider>
            ...
            >
              <EntryContextProvider>
                <AstralPoetLayoutContent>{children}</AstralPoetLayoutContent>
              </EntryContextProvider>
            </DeviceContextProvider>
          </InstallPromptProvider>
        </ThemeProvider>
