...
> = {
  h1: 'h1' as unknown as ComponentType<React.HTMLAttributes<HTMLHeadingElement>>,
  h2: 'h2' as unknown as ComponentType<React.HTMLAttributes<HTMLHeadingElement>>,
  h3: 'h3' as unknown as ComponentType<React.HTMLAttributes<HTMLHeadingElement>>,
  h4: 'h4' as unknown as ComponentType<React.HTMLAttributes<HTMLHeadingElement>>,
  h5: 'h5' as unknown as ComponentType<React.HTMLAttributes<HTMLHeadingElement>>,
  h6: 'h6' as unknown as ComponentType<React.HTMLAttributes<HTMLHeadingElement>>,
  body1: 'p' as unknown as ComponentType<React.HTMLAttributes<HTMLParagraphElement>>,
  body2: 'p' as unknown as ComponentType<React.HTMLAttributes<HTMLParagraphElement>>,
  subtitle1: 'p' as unknown as ComponentType<React.HTMLAttributes<HTMLParagraphElement>>,
  subtitle2: 'p' as unknown as ComponentType<React.HTMLAttributes<HTMLParagraphElement>>,
  caption: 'span' as unknown as ComponentType<React.HTMLAttributes<HTMLSpanElement>>,
  overline: 'span' as unknown as ComponentType<React.HTMLAttributes<HTMLSpanElement>>,
  p: 'p' as unknown as ComponentType<React.HTMLAttributes<HTMLParagraphElement>>,
  span: 'span' as unknown as ComponentType<React.HTMLAttributes<HTMLSpanElement>>,
  a: Link as unknown as ComponentType<React.AnchorHTMLAttributes<HTMLAnchorElement>>,
  label: 'label' as unknown as ComponentType<React.LabelHTMLAttributes<HTMLLabelElement>>,
  ...
  strong: 'strong' as unknown as ComponentType<React.HTMLAttributes<HTMLElement>>,
  ...
  address: 'address' as unknown as ComponentType<React.HTMLAttributes<HTMLElement>>,
};
