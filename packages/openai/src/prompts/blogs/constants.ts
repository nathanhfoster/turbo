...
export const AUDIENCE_GUIDELINES = {
  'local businesses': {
    focus: 'practical implementation, ROI, competitive advantage, operational efficiency',
  ...
  'economic developers': {
    focus: 'policy implications, regional impact, data-driven strategies, economic metrics',
    ...
    callToAction: 'leverage LocalScore data for informed economic development decisions',
  },
  'city leaders': {
    focus: 'governance, civic engagement, policy making, public trust, transparency',
    ...
    callToAction: 'implement LocalScore for transparent, data-driven civic decision-making',
  },
  professionals: {
    focus: 'career advancement, networking, skill development, professional growth',
    ...
    callToAction: "advance your career through LocalScore's professional community network",
  },
  'community members': {
    focus: 'personal empowerment, local impact, consumer choices, community participation',
    ...
    callToAction: 'join the movement to support businesses making measurable community impact',
  },
} as const;
...
export const CATEGORY_FRAMEWORKS = {
  professional: {
    ...
    connections: 'professional growth through verified community impact contributions',
  ...
  social: {
    ...
    connections: 'strengthening social connections through transparent business practices',
    manifestAlignment: 'connecting communities with companies making measurable change',
  },
  local: {
    themes: [
      'local economy',
    ...
    connections: 'empowering local economic development through verified impact measurement',
  ...
  business: {
    ...
    connections: 'business transformation through blockchain-verified impact scores',
  ...
  finance: {
    ...
    connections: 'creating new financial models through verified business impact data',
    manifestAlignment: 'blockchain-verified business impact scores for financial decision-making',
  },
  community: {
    themes: [
      'community empowerment',
    ...
    connections: 'empowering communities through transparent, measurable impact data',
    manifestAlignment: 'connecting communities with companies making measurable change',
  },
  web3_innovation: {
    themes: [
    ...
    connections: 'leveraging Web3 technology for authentic community impact verification',
    manifestAlignment: 'built on bleeding-edge infrastructure and Web3 platform capabilities',
  },
  ai_revolution: {
    themes: [
    ...
    connections: 'AI agents enhancing human potential in community and business development',
    manifestAlignment:
...
export const MISSION_ANGLES = {
  ...
  smart_contracts: 'Smart contracts enabling transparent, automated impact verification',
  ai_enhancement: 'AI agents that enhance human potential rather than replace human judgment',
  community_empowerment: 'Returning local impact measurement power to communities and people',
  economic_development: 'Transparent tools for local economic developers and city leaders',
  measurable_change: 'Connecting communities with companies making verifiable, measurable impact',
  bleeding_edge: 'Cutting-edge infrastructure and frontend technology leadership',
} as const;
