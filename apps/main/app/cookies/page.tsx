      ...
      <Box className="mt-8 space-y-6">
        <Box variant="section">
          ...
          <Typography variant="p" className="text-gray-700 dark:text-gray-300">
            ...
            outlines what these technologies are, why we use them, and your
            rights to control their use. This policy also covers our Progressive
            Web Application (PWA) features and related data storage mechanisms.
          </Typography>
        </Box>
        ...
        <Box variant="section">
          ...
          >
            ...
            more efficiently, as well as to provide information to the website
            owners. In addition to cookies, modern web applications may use
            other storage mechanisms such as:
          </Typography>
          <Box
            variant="ul"
            className="list-disc pl-6 text-base text-gray-700 dark:text-gray-300"
          >
            ...
            <Typography variant="li">
              Cache Storage (for PWA features)
            </Typography>
          </Box>
        </Box>
        ...
        <Box variant="section">
          ...
          <Typography
            ...
            className="mb-4 text-gray-700 dark:text-gray-300"
          >
            We use cookies and other storage mechanisms to enhance your browsing
            experience by:
          </Typography>
          <Box
            variant="ul"
        ...
        <Box variant="section">
          ...
          >
            ...
            <Typography variant="li">
              <strong>PWA Storage:</strong> Used for offline functionality and
              app performance.
            </Typography>
          </Box>
        </Box>
        ...
        <Box variant="section">
          ...
          <Typography
            ...
            className="mb-4 text-gray-700 dark:text-gray-300"
          >
            Our website functions as a Progressive Web Application, which means
            it can be installed on your device and work offline. To enable these
            features, we use:
          </Typography>
          <Box
            variant="ul"
          ...
          >
            <Typography variant="li">
              <strong>Service Workers:</strong> For offline functionality and
              background sync
            </Typography>
            <Typography variant="li">
              <strong>Cache Storage:</strong> To store website resources for
              offline use
            </Typography>
            <Typography variant="li">
              <strong>Push Notifications:</strong> To send you important updates
              (with your permission)
            </Typography>
            <Typography variant="li">
              <strong>App Manifest:</strong> To enable installation on your
              device
            </Typography>
          </Box>
        </Box>
        ...
        <Box variant="section">
          ...
          >
            Please note that disabling certain features may affect the
            functionality of our website and PWA capabilities. For more detailed
            information, refer to your browser's help documentation.
          </Typography>
        </Box>
        ...
        <Box variant="section">
          ...
          <Typography variant="p" className="text-gray-700 dark:text-gray-300">
            ...
            changes in legal, technical, or business developments. We encourage
            you to review this page periodically for the latest information on
            our use of cookies and PWA features.
          </Typography>
        </Box>
        ...
        <Box variant="section">
          ...
          <Typography variant="p" className="text-gray-700 dark:text-gray-300">
            If you have any questions about our use of cookies, PWA features, or
