...
import NovelEditor from "./index";
import type { JSONContent } from "novel";
import Box from "../../atoms/Box";
import Typography from "../../atoms/Typography";

const meta = {
  title: "organisms/NovelEditor",
  ...
  argTypes: {
    ...
    showBubbleMenu: {
      control: "boolean",
      description: "Whether to show the bubble menu for formatting",
    },
    defaultValue: {
      control: "text",
...
// With JSONContent (programmatic example)
    ...
    initialContent: {
      ...
      content: [
        ...
        },
        {
          type: "paragraph",
          content: [
            { type: "text", text: "This content was set using " },
            { type: "text", marks: [{ type: "bold" }], text: "JSONContent" },
