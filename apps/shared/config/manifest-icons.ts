import type { ManifestIcon } from "@nathanhfoster/pwa/manifest-helpers";

/**
 * Shared manifest icon sets
 * Use these in your app's manifest.ts
 */

export const STANDARD_MANIFEST_ICONS: ManifestIcon[] = [
  {
    src: "/favicon.ico",
    sizes: "48x48",
    type: "image/x-icon",
...
/**
 * Full manifest icon set including all iOS sizes
 * Use this if you need comprehensive iOS icon support
 */
export const FULL_MANIFEST_ICONS: ManifestIcon[] = [
