...
const HEADING_TEXT_COLOR = "!text-gray-900 dark:!text-gray-100";

export const TYPOGRAPHY_VARIANT_STYLES: Record<TypographyVariant, string> = {
  h1: `${BASE_TRANSITION} ${HEADING_TEXT_COLOR}`,
  h2: `${BASE_TRANSITION} ${HEADING_TEXT_COLOR}`,
  h3: `${BASE_TRANSITION} ${HEADING_TEXT_COLOR}`,
  h4: `${BASE_TRANSITION} ${HEADING_TEXT_COLOR}`,
  h5: `${BASE_TRANSITION} ${HEADING_TEXT_COLOR}`,
  h6: `${BASE_TRANSITION} ${HEADING_TEXT_COLOR}`,
